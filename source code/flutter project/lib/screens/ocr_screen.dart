...
class OCR_Screen extends StatefulWidget {
  const OCR_Screen({Key? key}) : super(key: key);

  @override
  State<OCR_Screen> createState() => _OCR_ScreenState();
}

class _OCR_ScreenState extends State<OCR_Screen> {
  io.File? _image;
  ...
  Future getImage() async {
    ...
    if(message == '')
      {
        message = msg = 'No text has been recognized!';
      }
    speak();
  }
